...
_$AppState$ _$$AppState$FromJson(Map<String, dynamic> json) => _$AppState$(
      ...
      users: json['users'] == null
          ? const UsersState()
          : UsersState.fromJson(json['users'] as Map<String, dynamic>),
      messages: json['messages'] == null
          ? const ChatState()
          : ChatState.fromJson(json['messages'] as Map<String, dynamic>),
    );
...
Map<String, dynamic> _$$ApiImage$ToJson(_$ApiImage$ instance) =>
    <String, dynamic>{
...
_$UnsplashUser$ _$$UnsplashUser$FromJson(Map<String, dynamic> json) =>
    _$UnsplashUser$(
...
Map<String, dynamic> _$$UnsplashUser$ToJson(_$UnsplashUser$ instance) =>
    <String, dynamic>{
...
_$ImageState$ _$$ImageState$FromJson(Map<String, dynamic> json) =>
    _$ImageState$(
...
Map<String, dynamic> _$$ImageState$ToJson(_$ImageState$ instance) =>
    <String, dynamic>{
      'favorites': instance.favorites,
      'images': instance.images,
    };

_$UsersState$ _$$UsersState$FromJson(Map<String, dynamic> json) =>
    _$UsersState$(
...
Map<String, dynamic> _$$UsersState$ToJson(_$UsersState$ instance) =>
    <String, dynamic>{
      'users': instance.users,
    };
...
Map<String, dynamic> _$$ChatState$ToJson(_$ChatState$ instance) =>
    <String, dynamic>{
      'messages': instance.messages,
    };
